/* -------------------------------------------------------------------------- */
/*                          CASO 1: LOS CUATROATLETAS                         */
/* De cuatro corredores de atletismo se sabe que C ha llegado inmediatamente  */
/* detrás de B, y D ha llegado en medio de A y C. ¿podría usted calcular el   */
/* orden de llegada?
/* -------------------------------------------------------------------------- */
...
/* viejo que el de Jack, que es aún más lento que el de Willy, que es más     */
/* joven que el de Mac, que es más viejo que el de Smith, que es más claro    */
/* que el de Willy, aunque el de Jack es más lento y más oscuro que el de     */
...
/* Éste último come más que el galgo; el alano come más que el galgo y menos  */
/* que el dogo, pero éste come más que el podenco. ¿Cuál de los cuatro perros */
/* come menos?.                                                               */
/* -------------------------------------------------------------------------- */
...
/* cada dos, utilizar diferentes medios de transporte; sabemos que Alejandro  */
/* no utiliza el coche ya que éste acompaña a Benito que no va en avión.      */ 
/* Andrés viaja en avión. Si Carlos no va acompañado de Darío ni hace uso del */
/* avión, podría Vd. decirnos en qué medio de transporte llega a su           */
/* destino Tomás.                                                             */
/* -------------------------------------------------------------------------- */
	...
	intervalo: setInterval(function(){
		...
		if(d.resultado()){
			...
			if(d.tomas.transporte == 1){
				console.log("Tomás viaja en avión");
			
			} else if(d.tomas.transporte == 2){
				console.log("Tomás viaja en coche");

			} else{
				console.log("Tomás viaja en otro transporte");
			};
